    ...
    <footer class="main-footer" style="background: #002d5a; color: #fff; padding: 2rem 0 1.5rem; border-top: 5px solid var(--accent);">
        <div class="container footer-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem;">
            ...
            <div class="footer-section">
                ...
                <ul style="list-style: none; padding: 0;">
                    <li style="margin-bottom: 0.5rem;"><a href="/TuneTrove/user/about.php" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;">About Us</a></li>
                    <li style="margin-bottom: 0.5rem;"><a href="/TuneTrove/user/contact.php" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;">Contact & Support</a></li>
                    <li style="margin-bottom: 0.5rem;"><a href="/TuneTrove/user/shipping.php" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;">Shipping Info</a></li>
                    <li style="margin-bottom: 0.5rem;"><a href="/TuneTrove/user/privacy.php" style="color: #a0aec0; text-decoration: none; transition: color 0.2s;">Privacy Policy</a></li>
                </ul>
            </div>
            <div class="footer-section">
                <h4 style="color: #fff; text-transform: uppercase; letter-spacing: 0.1em; font-size: 0.85rem; margin-bottom: 1rem;">Shop By Category</h4>
                <ul style="list-style: none; padding: 0;">
        ...
        <div style="border-top: 1px solid rgba(255,255,255,0.1); margin-top: 2rem; padding-top: 1rem;">
            <div class="container" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                <p style="color: #718096; font-size: 0.85rem;">&copy; <?php echo date('Y'); ?> TuneTrove Inc. All rights reserved.</p>
                <div style="display: flex; gap: 1rem;">
                    <span style="color: #718096; font-size: 0.85rem;">(800) 222-4700</span>
                    <span style="color: #718096; font-size: 0.85rem;">Free Shipping on almost everything!</span>
                </div>
            </div>
        </div>
    </footer>
